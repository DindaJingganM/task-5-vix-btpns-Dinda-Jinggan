      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <form class="form" method="get" action="{{ url('galeri') }}">
                ...
                <table class="table table-stripped table-bordered zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_o_info">
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td><img src="{{asset('storage/app/public/'.$item->gambar)}}" width="50px" style="border-radius: 100px;"></td>                      <td>{{$item->Keterangan}}</td>
                      <td class="sorting_1">{{$item->created_at}}</td>
                      <td>
                        <div class="btn-group">
                          <a href="{{url('galeri/'.$item->id.'/edit')}}" class="btn btn-primary"><img src="img/edit.png"></a>
                          <form action="{{url('galeri/'.$item->id )}}" method="POST" id="delete-{{ md5($item->id) }}">
                            @method('delete')
                            @csrf
